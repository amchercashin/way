    ...
    <div className="border border-[rgba(200,180,140,0.08)] rounded-lg p-3.5 mt-3">
      ...
      <div className="space-y-1 text-xs">
        <div className="flex justify-between">
          <span className="font-mono text-[length:var(--way-text-caption)] text-[var(--way-muted)]">Размер</span>
        ...
        <div className="flex justify-between">
          <span className="font-mono text-[length:var(--way-text-caption)] text-[var(--way-muted)]">Отсечка (ожид.)</span>
          <span className="font-mono text-[length:var(--way-text-body)] text-[var(--way-text)]">{formatDate(nextExpectedCutoffDate)}</span>
        </div>
        <div className="flex justify-between">
          <span className="font-mono text-[length:var(--way-text-caption)] text-[var(--way-muted)]">Выплата (ожид.)</span>
          <span className="font-mono text-[length:var(--way-text-body)] text-[var(--way-text)]">{formatDate(nextExpectedDate)}</span>
        </div>
        <div className="flex justify-between">
          <span className="font-mono text-[length:var(--way-text-caption)] text-[var(--way-muted)]">Зачисление (ожид.)</span>
          <span className="font-mono text-[length:var(--way-text-body)] text-[var(--way-text)]">{formatDate(nextExpectedCreditDate)}</span>
        </div>
      </div>
    </div>
  );
